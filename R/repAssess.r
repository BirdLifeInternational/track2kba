...
#'
#' @param tracks SpatialPointsDataFrame or data.frame of animal relocations. Must include 'ID' field. If input is data.frame or unprojected SpatialPointsDF, must also include 'Latitude' and 'Longitude' fields.
...
#' @param levelUD numeric. Specify which contour of the Utilization Distribution the home range estimate (\code{KDE}) represented (e.g. 50, 95). 
...
repAssess <- function(tracks, KDE=NULL, iteration=50, res=NULL, levelUD=50, avgMethod = "mean", nCores=1, bootTable=FALSE){
