...
#'
#' @param dataGroup data.frame. Tracking data, with fields named as named by \code{\link{formatFields}}.
#' @param reproject logical (TRUE/FALSE). If your dataGroup dataframe is already projected, would you like to reproject these to a custom equal-area projection?
#' 
#' Input data can be tracks split into trips (i.e. output of \code{\link{tripSplit}}).
#' 
