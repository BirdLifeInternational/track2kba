...
```{r repAssess}
### THIS DOES NOT WORK WHEN BUILDING PACKAGE. Problem with parallel processing...
# options(mc.cores=0)
# repr <- repAssess(trips, listKDE = KDEs$KDE.Surface, Iteration=1, BootTable = FALSE, Ncores=1)
