...
Then, we can combine all the polygons within the 'potentialSite' area, and using the maximum number of individuals present in that area we can assess whether it merits designation as a Key Biodiversity Area according to the KBA standard.
