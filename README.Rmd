...
```{r example, message=FALSE, warning = FALSE, include=F}
...
```{r warning = FALSE, message=FALSE, include=F, fig.height=7, fig.width=7}
trips <- tripSplit(
  tracks     = tracks, 
  Colony     = colony, 
...
```{r estSpaceUse, warning = FALSE, message = FALSE, include = FALSE, fig.width=5, fig.height=4, dpi=300}
KDEs <- estSpaceUse(
  DataGroup = trips, 
  Scale = Hvals$mag, 
  UDLev = 50, 
...
knitr::include_graphics("man/figures/boobies_representativeness_h3_tripBuff3_N41.png", dpi=50)
```
